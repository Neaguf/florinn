<template>
        <base-page>
        <titlu-pagina Titlu="Produse" @on_add_clicked="show_dialog()" :AdaugaVisible='true' />
...
<el-table :data="Results" >
    <el-table-column prop='Id' label='Id'></el-table-column><el-table-column prop='Nume' label='Nume'></el-table-column><el-table-column prop='Pret' label='Pret'></el-table-column><el-table-column fixed="right" label="Actiuni" width="200px" >
