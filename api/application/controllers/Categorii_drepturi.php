...
class Categorii_drepturi extends BP_Controller
{
    ...
    public function index()
    {
        ...
        if(!$ret->NotLogged)
        {
            ...
            $sql          = new TableSql( "SELECT t1.* FROM rights_category t1 WHERE 1=1  " );
    ...
    public function get_info_item_dialog()
    {
        ...
        if(!$ret->NotLogged)
        {
            ...
            $ret->Item           = new DbRightsCategoryModel($id);
        }
    ...
    public function delete_item()
    {
        ...
        {
            $id = $this->input->post( "id" );
            $a  = new DbRightsCategoryModel($id);
            $a->Delete();
        }
