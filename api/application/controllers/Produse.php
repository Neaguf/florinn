...
class Produse extends BP_Controller
{
    ...
    public function index()
    {
        ...
        if(!$ret->NotLogged)
        {
            ...
            $sql          = new TableSql( "SELECT t1.* FROM produse t1 WHERE 1=1  " );
    ...
    public function get_info_item_dialog()
    {
        ...
        if(!$ret->NotLogged)
        {
            ...
            $ret->Item           = new DbProduseModel($id);
